...
_VOICE_SHORTLIST: List[Voice] = [
    Voice(id="en-US-ChristopherNeural", label="Christopher", language="en-US", gender="male", tags=["narration"]),
    Voice(id="en-US-GuyNeural", label="Guy", language="en-US", gender="male", tags=["energetic"]),
    Voice(id="en-US-EricNeural", label="Eric", language="en-US", gender="male", tags=["casual"]),
    Voice(id="en-US-RogerNeural", label="Roger", language="en-US", gender="male", tags=["deadpan"]),
    Voice(id="en-US-JennyNeural", label="Jenny", language="en-US", gender="female", tags=["narration"]),
    Voice(id="en-US-MichelleNeural", label="Michelle", language="en-US", gender="female", tags=["casual"]),
    Voice(id="en-GB-RyanNeural", label="Ryan", language="en-GB", gender="male", tags=["meme-lord"]),
